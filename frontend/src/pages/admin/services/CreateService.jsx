...
import { createServiceAPI } from '../../../api/admin/services';
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            Object.keys(formData).forEach(key => {
                if (key !== 'image') { // image handled separately as file
        ...
        <div className="max-w-4xl mx-auto pb-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    ...
                    <p className="text-slate-500">Add a new medical service to the catalog</p>
                </div>
            </div>
